 ...
 * Tenta validar: TMDb primeiro (fuzzy) → OMDb (exato).
 * Monta a mensagem do WhatsApp e devolve tudo pronto pra rota gravar no Dropbox.
 */
 ...
 * pendente (sem link), tenta confirmar de novo (TMDb → OMDb) e, se conseguir,
